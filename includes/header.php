...
if (!isset($_SESSION['user_id'])) {
  echo "<div class='navbar-nav ms-auto'>
                <a href='http://{$_SERVER['SERVER_NAME']}/lensify/e-commerce2/user/login.php' class='nav-item nav-link'>Login</a></div>";
} else {
  echo "<div class='navbar-nav ms-auto'>
                <a href='http://{$_SERVER['SERVER_NAME']}/lensify/e-commerce2/user/logout.php'  class='nav-item nav-link'>Logout</a></div>";
}
?>
      </div>
    </div>
